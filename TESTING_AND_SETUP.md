...
4. Open Accounts → Monitor & automatic channel setup. Enter the monitor bot token
   ...
   admin space can use `LAZYFARMERS_MONITOR_TOKEN`.
5. Add/import your accounts. Leave their channel fields empty if using automatic
   setup. Stop any running accounts before continuing.
