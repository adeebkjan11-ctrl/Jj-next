...
function accountConfigCard(acc) {
    ...
    const channels = (acc.channels || []).join(' ') || 'Awaiting Monitor Bot setup';
...
window.showBulkImport = function() {
    ...
    document.getElementById('bulk-channel-options').open = false;
...
window.showAccountForm = function(index = -1) {
    ...
    document.getElementById('acct-channel-options').open = !!document.getElementById('acct-form-channels').value;
