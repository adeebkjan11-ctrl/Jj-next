...
function saveAllConfigs() {
    ...
    fetch(`/api/settings${q}`, {
        ...
        originalConfig = JSON.parse(JSON.stringify(currentConfig));
        checkDirty();
        showToast(currentAccountId ? `Settings saved for account ${currentAccountId}` : 'Default settings saved. Account overrides are preserved; use Apply to all to replace them.');
