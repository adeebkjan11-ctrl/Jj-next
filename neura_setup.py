...
async def setup_menu():
    while True:
        ...
        if choice == "1":
            ...
            console.print("\n[green]launching Lazy Farmers...[/green]")
            time.sleep(1)
            import neura
            await neura.main()
            break
            ...
            console.print("\n[magenta]thank you for using Lazy Farmers.[/magenta]")
            break
...
async def quick_start():
    ...
    console.print("[green]Launching Lazy Farmers...[/green]")
    import neura
    await neura.main()

def main():
    parser = argparse.ArgumentParser(description="Lazy Farmers Setup")
